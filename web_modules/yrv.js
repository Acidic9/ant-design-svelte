...
import { w as writable } from './common/index-0b798f3e.js';
...
/* node_modules/yrv/build/lib/Router.svelte generated by Svelte v3.29.7 */
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty & /*condition, $router*/ 1032) {
			 if (condition) {
	...
	return [disabled, basePath, path, condition, $$scope, slots];
}
...
/* node_modules/yrv/build/lib/Route.svelte generated by Svelte v3.29.7 */
...
function create_else_block_1(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			if (default_slot) {
				if (default_slot.p && dirty & /*$$scope, activeRouter, activeProps*/ 8204) {
...
function instance$1($$self, $$props, $$invalidate) {
	let $routePath;
	let $routeInfo;
	component_subscribe($$self, routeInfo, $$value => $$invalidate(17, $routeInfo = $$value));
	let { $$slots: slots = {}, $$scope } = $$props;
	let { key = null } = $$props;
	let { path = "/" } = $$props;
